...
#
# Bundled skills: mas-engineer/skills/ (in the repo) -> <TARGET> (user-supplied)
#
...
#   give it a target path and it copies the repo's mas-engineer/skills/ there.
#
...
#
# Usage:
#   bash scripts/skills-install.sh                          # target = ./mas-engineer/skills (no-op install)
...
SKILLS_SRC="$ROOT/mas-engineer/skills"

# Target = CLI arg if given, else repo-relative mas-engineer/skills/ (no-op).
