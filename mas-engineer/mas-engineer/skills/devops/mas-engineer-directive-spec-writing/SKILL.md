...
- For Hermes-side skill updates (those go in skills/, not .directives/)
...
Directives go in `mas-engineer/.directives/` (NOT at repo root).
...
template in `mas-engineer/.directives/test-fixtures/` (NOT in
`tests/`). The template is:

  - All tests marked @ pytest.mark.skip
  - File is NON-discoverable by pytest (lives in .directives/,
...
8-commit example showing spec-iteration over a single directive:
  ...
  - R110-79 (04afe4a): create .directives/ at repo root
  - R110-80 (5f9418e): move .directives/ into mas-engineer/
  ...
  - R110-85 (f5204f5): add .directives/README.md index
  - R110-86 (74c6835): add .directives/STATUS.md tracker
  - R110-87 (db5bdd0): add .directives/test-fixtures/ template
