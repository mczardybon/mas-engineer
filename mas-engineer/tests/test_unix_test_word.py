...
# These are test/clone artifacts generated by workflows (wf_yaml_clone,
# test runs) and are NOT deployable agents. They are ephemeral working-tree
# files: e2e_run_all.py cleanup step (line 244-258) deletes them, but pytest
# may see them before cleanup runs. See R110-34 commit for context.
RECIPE_EXCLUDE = {
