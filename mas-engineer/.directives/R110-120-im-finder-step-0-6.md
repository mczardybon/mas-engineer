...
## SCOPE
  ...
  - .directives/STATUS.md (PHASE 3b R110-78 = DONE entry)
  - .state/directive_already_applied.json (auto-updated by
    dispatch)
...
python3 tools/dev_directive_applier.py --hook pre-apply \
  .directives/R110-120-im-finder-step-0-6.md
...
echo "per directive .directives/R110-120-im-finder-step-0-6.md apply DIREKTIVE 1+2+3+4: insert STEP 0.6 in im-finder.md (sub_mas-self-audit pre-write), add sub_mas-self-audit to im-finder.yaml sub_recipes, add STEP 0.6 test, verify clean. ack" | \
