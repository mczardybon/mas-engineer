...
## SCOPE
  ...
  - .directives/STATUS.md (R110-121 entry, R110-78 PHASE 3c DONE)
...
python3 tools/dev_directive_applier.py --hook pre-apply \
  .directives/R110-121-stale-literal-fix.md
...
echo "per directive .directives/R110-121-stale-literal-fix.md apply DIREKTIVE 1+2+3+4: replace sales examples with sub_mas-dev-team in 3 files (team-packager + 2 HOWTO docs), improve dev_self_audit Pattern B for im-finder L146 false positive, add test_pattern_b_stale_literal_detected, verify clean. ack" | \
