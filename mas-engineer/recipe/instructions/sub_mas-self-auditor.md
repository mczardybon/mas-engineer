...
claim (e.g. the words "VERIFIED-FUNCTIONAL" with that exact hyphenation,
or "ALL-HYPOTHESES-VERIFIED", or "100%-PASS")
...
audit_run:
  ...
  findings:
    - id: SC-001
      ...
      line: 42
      claim: "[strong-claim-text]"  # placeholder, real value is the matched phrase
      pattern: "STRONG_CLAIM"  # which pattern matched
      evidence_found: false | path/to/log
      evidence_relevant: false | true
      explanation: "Claim '[strong-claim-text]' has no matching test log."
