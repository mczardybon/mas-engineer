...
Arbeite in a Kopie, merge erst bei Success.
...
- FIND_BEST: Analysiert all Checkpoints, finds den optimalen
- RESTORE_BEST: Automatic againhcreate
- SHOW_PATH: Zeigt den gefundenen Path
Sub: sub_mas-recovery-timeline

## Level 5: DEFIB (Emergency-Resuscitation)
Last resort bei Total failure.
- DEFIB: Minimum-Config laden (only immune + checkpoint)
...
recovery --restore <id>   # Wiederhcreate
