...
- .mase/mcp/server.js (Node.js MCP server, 3335 bytes)
- .mase/mcp/dashboard.html (19.5KB, chart.js webapp)
...
- web-searcher.yaml, source-verifier.yaml (MANDATORY), fact-extractor.yaml, synthesizer.yaml
- .mase/dashboards/data.json (1500B, 12 keys, agents: total=5, healthy=5, avg_score=1.0)
- .mase/mcp/server.js (3335B, starts: "Framework Dashboard MCP Server running")
- .mase/mcp/dashboard.html (19.5KB), mas-dispatch-monitor.html
- ~/.config/goose/config.yaml: framework-dashboard extension registered
