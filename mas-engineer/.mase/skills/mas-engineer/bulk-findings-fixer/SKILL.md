...
## Purpose
Apply template-injection fixes to recipe files based on `.mase/pipeline/findings.yaml`. Roughly 88% of findings (1,691 of 1,929 in the round this was built for) fall into auto-fixable categories.
...
python3 tools/bulk_findings_fixer.py --findings .mase/pipeline/roundN_findings.json
```
