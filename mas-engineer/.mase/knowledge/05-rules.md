...
Confirmation valid: 5 minutes (.mase/.last_confirmation)
...
## Rule files
.mase/rules/hard_rules.yaml      → All rules with hardening levels
.mase/rules/rules_5_extreme.yaml   → Only extremely strong rules (R01-R18)
.mase/rules/rules_4_strong.yaml    → Only strong rules (R06, R16, R17)
.mase/rules/rules_2_normal.yaml   → Only normal rules (R07-R08, R12-R15)
