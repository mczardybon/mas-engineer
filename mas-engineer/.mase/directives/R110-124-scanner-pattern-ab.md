...
## SCOPE
  ...
  - .mase/directives/STATUS.md (R110-124 entry)
...
python3 tools/dev_directive_applier.py --hook pre-apply \
  .mase/directives/R110-124-scanner-pattern-ab.md
