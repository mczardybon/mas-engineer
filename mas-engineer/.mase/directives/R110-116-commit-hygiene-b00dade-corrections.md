...
docs/ + .mase/directives/ (kein recipe/, kein tools/, kein tests/)
...
1. PRE-APPLY: `python3 tools/dev_directive_applier.py --hook pre-apply \
   .mase/directives/R110-116-commit-hygiene-b00dade-corrections.md`
...
git add docs/architecture/R110-115-b00dade-body-corrections.md \
        .mase/directives/R110-116-commit-hygiene-b00dade-corrections.md \
        mas-engineer/.mase/directives/STATUS.md
