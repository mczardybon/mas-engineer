...
3. Test-fixture template in `.mase/directives/test-fixtures/` (see file
...
- **pytest-hook**: No direct hook. The test-fixture template
  (`.mase/directives/test-fixtures/test_check_16_drift.py.template`) covers
...
`.mase/directives/test-fixtures/test_check_16_drift.py.template` — copy
