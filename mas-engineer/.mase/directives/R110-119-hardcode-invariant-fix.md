...
.mase/directives/STATUS.md (PHASE 3a = DONE, R110-118+119)
...
- .mase/directives/STATUS.md PHASE 3a = DONE
...
python3 tools/dev_directive_applier.py --hook pre-apply \
  .mase/directives/R110-119-hardcode-invariant-fix.md
...
echo "per directive .mase/directives/R110-119-hardcode-invariant-fix.md apply DIREKTIVE 1+2+3+4: fix simple-stale hardcode + research context-dependent + fix INVARIANT blockers + re-run. ack" | \
