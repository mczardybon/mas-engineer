...
vorhanden. Wenn mas-engineer PHASE 1 implementiert:
  ...
  3. mas-engineer (oder User):
     a) kopiert diese file von .mase/directives/test-fixtures/
...
VERWENDUNG:
  1. Pre-PHASE-1: file bleibt unter .mase/directives/test-fixtures/,
...
Referenz-direktive: .mase/directives/R110-78-spec-drift.md, DIREKTIVE 1,
section 8 ("WIE TESTEN").

NACH DIESEM FILE-PATTERN: weitere R110-* direktiven koennen
aehnliche test-fixture-templates in .mase/directives/test-fixtures/
...
#   1. cp .mase/directives/test-fixtures/test_r11078_spec_drift_template.py \
