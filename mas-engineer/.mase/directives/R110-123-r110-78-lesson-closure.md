...
## SCOPE
  ...
  - .mase/directives/STATUS.md (3 sections updated: R110-78 entry
...
python3 tools/dev_directive_applier.py --hook pre-apply \
  .mase/directives/R110-123-r110-78-lesson-closure.md
...
echo "per directive .mase/directives/R110-123-r110-78-lesson-closure.md apply DIREKTIVE 1+2+3+4: update STATUS.md R110-78 entry Overall (3/3 → 5/5 mas-engineer PHASEN done, add Status: ARCHIVED-READY), add new section '## R110-78 lesson — spec-drift = ARCHIVED' with PHASE 1+2+3+3b+3c+4 summary + total impact. Doc-only, no test changes. ack" | \
...
# 3. verify
git diff .mase/directives/STATUS.md | head -50
